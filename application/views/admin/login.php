...
<body class="hold-transition login-page">
  <div class="login-box">
   ...
   <!-- Material form login -->
   <p class="login-box-msg"> <img style="width: 150px" src="<?php echo base_url().'assets/mockup/core/img/logo.jpeg'?>"></p><hr/>
   <div class="card">
   ...
   <div class="card-body px-lg-6 pt-0">
    ...
    <!-- Form -->
    <form class="text-center" style="color: #757575;" action="<?php echo base_url().'admin/login/auth'?>" method="post">
      ...
      <!-- Social login -->
      <p><center>Copyright <?php echo date('Y');?> by PT Bintang Muara Sejati <br/> All Right Reserved</center></p>
